    ...
    for row in range(3):
        for column in range(3):
            if board[row][column] == " ":
                ...
                score = minimax(board, 0, False, symbol_1, symbol_2)
                board[row][column] = " "
...
def minimax(board, depth, is_maximizing, symbol_1, symbol_2):
    ...
    if is_maximizing:
        ...
        for row in range(3):
            for column in range(3):
                if board[row][column] == " ":
                    board[row][column] = symbol_2
                    score = minimax(board, depth + 1, False, symbol_1, symbol_2)
                    board[row][column] = " "
        ...
        for row in range(3):
            for column in range(3):
                if board[row][column] == " ":
                    board[row][column] = symbol_1
                    score = minimax(board, depth + 1, True, symbol_1, symbol_2)
                    board[row][column] = " "
